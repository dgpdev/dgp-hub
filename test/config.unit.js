...
describe('Config', function() {
  ...
  describe('@getPaths', function() {
    it('it will use defaults if confpath and datadir are undefined', function() {
      ...
      expect(paths.datadir).to.equal(process.env.HOME + '/.dgp-hub');
      expect(paths.confdir).to.equal(process.env.HOME + '/.dgp-hub/config');
      expect(paths.confpath).to.equal(process.env.HOME + '/.dgp-hub/config/development');
    });
